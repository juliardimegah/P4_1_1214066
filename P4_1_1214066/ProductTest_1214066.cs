...
{
    internal class ProductTest_1214066
    {
        static void Main(string[] args)
        {
            Book_1214066 product1 = new Book_1214066("Book", "C# Object Oriented Solution", "300");
            DVD_1214066 product2 = new DVD_1214066("Ethernal Sunshine Of The Spotless Mind", "145");
